...
public class PerformanceMetricsService : BackgroundService
{
    ...
    private async Task CollectSystemMetricsAsync()
    {
        ...
        try
        {
            ...
            var networkThroughput = _networkCounter.NextValue();
        ...
        {
            _logger.LogWarning(ex, "Failed to collect system metrics for tenant {TenantId}", _tenantConfiguration.TenantId);
        }
