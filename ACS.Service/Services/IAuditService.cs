...
public interface IAuditService
{
    ...
    Task<ACS.Service.Responses.RecordAuditEventResponse> RecordEventAsync(ACS.Service.Requests.RecordAuditEventRequest request);
    Task<ACS.Service.Responses.PurgeAuditDataResponse> PurgeOldDataAsync(ACS.Service.Requests.PurgeAuditDataRequest request);
    Task<ACS.Service.Responses.GetAuditLogResponse> GetAuditLogAsync(ACS.Service.Requests.GetAuditLogEnhancedRequest request);
    Task<ACS.Service.Responses.GetUserAuditTrailResponse> GetUserAuditTrailAsync(ACS.Service.Requests.GetUserAuditTrailRequest request);
    Task<ACS.Service.Responses.ValidateAuditIntegrityResponse> ValidateIntegrityAsync(ACS.Service.Requests.ValidateAuditIntegrityRequest request);
}
