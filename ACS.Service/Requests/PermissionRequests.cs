...
/// <summary>
/// Service request for bulk permission operations (non-generic)
/// </summary>
public record BulkPermissionRequest
{
    public ICollection<Dictionary<string, object>> Items { get; init; } = new List<Dictionary<string, object>>();
    public string Operation { get; init; } = string.Empty;
    public string RequestedBy { get; init; } = string.Empty;
}
...
/// </summary>
public record PermissionImpactRequest
{
    public int PermissionId { get; init; }
    public string Operation { get; init; } = string.Empty; // "Grant", "Revoke", "Update"
...
/// <summary>
/// Individual permission update in bulk operation
/// </summary>
public record PermissionUpdate
{
    ...
    public string EntityType { get; init; } = string.Empty;
    public int PermissionId { get; init; }
    public string Operation { get; init; } = string.Empty; // "Grant", "Revoke"
    public DateTime? ExpiresAt { get; init; }
}
